...
namespace ExemploPOO.Helper
{
    public class FileHelper
    {
        public void ListarDiretorios(string caminho)
				...
				public void ListarDiretoriosComSubPastas(string caminho)
				{
				...
				public void ListarArquivosDiretoriosComSubPastas(string caminho)
				{
				...
				public void ListarArquivosTxtDiretoriosComSubPastas(string caminho)
				{
